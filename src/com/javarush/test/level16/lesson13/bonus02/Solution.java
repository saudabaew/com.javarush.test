...
public class Solution {
    ...
    public static class Threads3 extends Thread
    {
        @Override
        public void run()
        {
    ...
    public static class Threads4 extends Thread implements Message
    {
        @Override
        public void run()
        {
    ...
    public static class Threads5 extends Thread
    {
        @Override
        public void run()
        {
